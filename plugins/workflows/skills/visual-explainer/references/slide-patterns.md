...
surf gemini "descriptive prompt matching deck palette" --generate-image "$TMPFILE" --aspect-ratio 16:9

# Base64 encode for self-containment (macOS)
TITLE_IMG=$(base64 -i "$TMPFILE")
# Linux: TITLE_IMG=$(base64 -w 0 "$TMPFILE")
