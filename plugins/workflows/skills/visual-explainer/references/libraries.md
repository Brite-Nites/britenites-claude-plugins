...
**Version pinning policy:** Always pin CDN imports to exact patch versions (e.g., `mermaid@11.12.3`, not `mermaid@11`). Floating major/minor versions risk silent breaking changes in generated output.
